 ...
 * Use the [FavoriteRepositoryFragment.newInstance] factory method to
...
class FavoriteRepositoryFragment : Fragment() {
    ...
    private fun moveToSearchRepositoryFragment() {
        findNavController().navigate(R.id.action_favoriteRepositoryFragment_to_searchRepositoryFragment)
    }
    
    private fun moveUserRepositoryFragment() {
        findNavController().navigate(R.id.action_favoriteRepositoryFragment_to_userRepositoryFragment)
    }
    companion object {
        /**
         ...
         * @return A new instance of fragment FavoriteRepositoryFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FavoriteRepositoryFragment().apply {
